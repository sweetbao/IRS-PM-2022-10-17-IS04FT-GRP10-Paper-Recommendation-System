    ...
    <span class="fs-4">
      <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Paper Recommend</a>
          ...
          <form class="d-flex login-container" v-if="token==''" @submit.prevent="submitFunc">
            <ul class="nav navbar-nav ">
              ...
              <li class="LiPadding"><button :disabled="account.username==='' | account.password===''" class="btn btn-outline-success" type="submit"
                  @click="LoginUser()">Login</button></li>

              <li class="LiPadding"><button :disabled="account.username==='' | account.password===''"  class="btn btn-success" type="submit" @click="RegisterUser()" >Sign Up</button>
              </li>
          ...
          <div v-if="token!=''" class="flex ">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="LiPadding"> <a class="nav-link" href="#">My Perference</a></li>
